...
public class Main {
    public static void main(String[] args) {
        ...
        //добвление строки в объект класса StringBuffer и возврат ссылки на тот же объект
        ...
        int[] firstArr = {1,2,3,4,9};
        int[] secondArr = {1,2,8,9,10};
        ...
        for (int i = secondArr.length; i < thirdArr.length; i++) {
            thirdArr[i] = secondArr[i - 5];
            System.out.println(Arrays.toString(thirdArr));
        }
